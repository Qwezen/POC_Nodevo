    ...
    <body>
        ...
        <div class="menu">
            ...
            <nav class="site-navigation">
                <ul class="nav">
                    <li><a href="#" class="fa">#Avant-premières</a></li> 
                    <li><a href="#" class="fa">#Agenda des sorties</a></li>
                    <li><a href="#" class="fa">#Films pour enfants</a></li>
                    <li><a href="#" class="fa">#Actus Ciné</a></li> 
                    <li><a href="#" class="fa">#Meilleur films</a></li> 
                </ul>
            </nav>
